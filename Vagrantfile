...
Vagrant.configure("2") do |root|
	root.vm.define 'Primary Vagrant' do |config|
		...
		config.vm.provision "puppet" do |puppet|
            ...
            puppet.environment_path = ["vm", "/vagrant/provision/environments"]
        ...
        #    puppet.module_path       = "provision/environments/production/modules"
        #    puppet.facter            = { "fqdn" => "pv" }
        ...
        puts "\033[38;5;196m================================================"
        puts ""
        puts "  \033[38;5;80mPrimary Vagrant:   \033[38;5;118m4.6"
        puts ""
